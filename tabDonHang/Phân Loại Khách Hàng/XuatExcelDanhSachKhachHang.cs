        ...
        public void xuatExcelDSKH(List<KhachHang> ListKhachHang)
        {
            ...
            try
            {
                using (ExcelPackage p = new ExcelPackage())
                {
                    ...
                    p.Workbook.Properties.Title = "Thống kê danh sách loại khách hàng";
                    p.Workbook.Worksheets.Add("Sheet1");
                    ExcelWorksheet worksheet = p.Workbook.Worksheets["Sheet1"];
                    worksheet.Name = "Sheet1";
                    worksheet.Cells.Style.Font.Size = 12;
                    worksheet.Cells.Style.Font.Name = "Arial";
                    string[] columnHeader = { "STT", "Tên khách hàng", "Số điện thoại", "Địa chỉ", "Tổng tiền đã mua", "Loại khách hàng"};
                    var numberOfColumn = columnHeader.Count();
                    worksheet.Cells[1, 1].Value = "Thống kê danh sách loại khách hàng";
